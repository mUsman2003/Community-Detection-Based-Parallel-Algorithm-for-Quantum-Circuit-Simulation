include("../src/TensorContraction_OpenMP1.jl")
...
# Then define main() after all helper functions
function main()
    # Run basic METIS test
    run_basic_metis_test()
    
    # Test with small circuit
    run_quantum_circuit_with_metis(8, 2, 4)
    ...
    if lowercase(response) == "y"
        run_quantum_circuit_with_metis(20, 8, 8)
    end
end
